...
| Atomize Studio | [packages/template-builder/CONTEXT.md](packages/template-builder/CONTEXT.md) | Desktop app covering Template authoring, Starting Paths, task generation, Catalog management, Connection Profile management, and its CLI launch gate. |
