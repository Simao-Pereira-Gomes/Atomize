...
| Atomize Studio | [packages/atomize-studio/CONTEXT.md](packages/atomize-studio/CONTEXT.md) | Desktop app covering Template authoring, Starting Paths, task generation, Catalog management, Connection Profile management, and its CLI launch gate. |
